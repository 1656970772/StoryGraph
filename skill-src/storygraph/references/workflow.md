...
6. Require the Stage 1 manifest, graphify outputs, requirement matrix, coverage ledgers, and gap report before any Stage 2 extraction.
7. Stage 2 is draft-first. Existing formal Markdown documents are not overwritten unless the configured output policy explicitly allows backup overwrite or merge.
