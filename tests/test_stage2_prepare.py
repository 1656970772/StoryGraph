    ...
    return {
        ...
        "stage2_render_policy": {
            ...
            "draft_entry_policy": {
                ...
                "field_aliases": {
                    "name": ["name", "title", "item_name", "entity_name", "名称"],
                    "classification": ["classification", "type", "category_label", "类别", "分类"],
                    "usage": ["usage", "purpose", "effect", "effects", "用途", "功效"],
                    "formula": [
                        "formula",
                        "materials",
                        "ingredients",
                    ...
                    "source_excerpt": ["source_excerpt", "original_excerpt", "quote", "原文摘录"],
                    "review_status": ["review_status", "verification_status", "审核状态"],
                },
                "fallback_name": "未命名条目",
                "kept_fields": [
                    "name",
            ...
            "final_entry_policy": {
                ...
                "required_any_fields": ["usage", "formula"],
                "unstable_name_prefixes": ["未名", "未命名", "未知", "不明"],
                "unstable_name_contains": ["某种", "某类"],
                "composite_name_markers": ["与", "或", "/", "、"],
